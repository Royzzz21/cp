                ...
                <div id='content_bbs' style="">
                    ...
                    <table id='bbs_table' class="table-bordered" border=1 cellspacing='0' cellpadding='0' width=100% style="padding:0 !important;;border:1px solid #d5d5d5;">
                        ...
                        <tr>
                            ...
                            <th style="width:;text-align:center;">project id</th>
                            <th style="width:10%;text-align:center;">project name</th>
                            <th style="width:50%;text-align:center;">Task list</th>
                            <th style="width:;text-align:center;">project status</th>
                            <th style="width:50px;text-align:center;">owner</th>
                            <th style="width:10%;text-align:center;">date</th>
                            <th style="width:10%;text-align:center;">Time Left</th>
                    ...
                    <!-- 제목 -->
                        <tr>
                            ...
                            <td>
                              <?php
                                    $project_list = get_project_list_child($row->project_name);
                                    foreach ($project_list as $k=>$v){
                                        echo '<p><a href="#">'. $v->task_name . '</a></p>';
                                    }
                                ?>
                            </td>
