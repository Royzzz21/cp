...
<head>
    ...
    <!-- Bootstrap Core Css -->
	<link href="/res/admin/plugins/bootstrap/css/bootstrap.css" rel="stylesheet">
...
<body class="login-page signup-page fp-page ls-closed">
	...
	<script src="/res/admin/plugins/node-waves/waves.js"></script>

	<!-- Validation Plugin Js -->
	<script src="/res/admin/plugins/jquery-validation/jquery.validate.js"></script>
	
    <!-- Custom Js -->
	<script src="/res/admin/js/admin.js"></script>
	<script src="/res/admin/js/pages/examples/sign-in.js"></script>
</body>
</html>
