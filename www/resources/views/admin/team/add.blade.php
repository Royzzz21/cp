                                                      ...
                                                      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"
                                                          ...
                                                          <tr>
                                                              ...
                                                              <td height="35" style="padding-left:5px;">
                                                                  ...
                                                                  <select id=selected_cat name=selected_cat value="">
                                                                      <? foreach(get_team_category() as $k=>$v){ ?>
                                                                  ...
                                                                  <script>
                                                                      <? if(isset($rows)){ ?>
                                                                      $('#selected_cat').children('[value="<?=$rows->cat?>"]').prop("selected", true);
                                                                      <?} ?>
