                                    ...
                                    <!-- 제목 -->
                                        <tr>
                                            ...
                                            <td ><?
                                                if($row->photo_ext){
                                                    ?>
                                                    <img src="/photo/press_photo/<?=$row->idx?>.<?=$row->photo_ext?>" style="width:100px;" />
                                                    <?
                                                }
                                            ...
                                            <td style="word-break: break-all;"><?=$row->link_url?></td>
                                            <td style="word-break: break-all;"><?=$row->news_title?></td>
