                          ...
                          <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                                  ...
                                                  <td>
                                                      ...
                                                      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"
                                                          ...
                                                          <tr style="">
                                                              ...
                                                              <td height="35" style="padding-left:5px;">
                                                                  <input type='text' id='posting_date' name='posting_date'
                                                                         value="<? if (isset($rows)) {
                                                                             echo $rows->posting_date;
                                                                         } ?>"

                                                                         style="width:200px;height:25px;line-height:25px;border:1px solid #bebebe;outline-style:none;padding:0;margin:0" AUTOCOMPLETE="OFF" />
                                                              </td>
                                                          </tr>
                                                          ...
                                                          <tr>
                                                              ...
                                                              <td height="35" style="padding-left:5px;">
                                                                  <input type='text' id='link_url' name='link_url'
                                                                         ...
                                                                         style="width:90%;height:25px;line-height:25px;border:1px solid #bebebe;outline-style:none;padding:0;margin:0"
                                                                         AUTOCOMPLETE="OFF"/>
                                                              </td>
                                                          </tr>
                                  ...
                                  <tr>
                                      <td height="77" align="left">
                                          ...
                                          <table border="1" align="left" cellpadding="0" cellspacing="0" bordercolor="#a5c9dc" bgcolor="#a5c9dc" width="100%">
                                              <tr>
                                                  <td><table border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
                                                          ...
                                                          <tr bgcolor="effaff">
                                                              <td align="center" bgcolor="#FFFFFF">
                                                                  ...
                                                                  <textarea id="wr_content" name="memo"
                                                                          style="FONT-SIZE: 12px;background-color:#FFFFFF;min-width:100%;height:100px;width:100%;"
                                                                          rows=15 itemname="설명"
