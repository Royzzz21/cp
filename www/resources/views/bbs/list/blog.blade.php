        ...
        <div class="clearfix">
            ...
            <div>
                ...
                */
                    ...
                    ?>
                    <table id='bbs_table' class="boardList cBlue" border=0 cellspacing='0' cellpadding='7' width="100%"
                           style="border:1px solid #dddddd;margin-bottom:10px;">
                        <tr>
                            <td>
                                <table border=0 cellspacing='0' cellpadding='0' width=100%
                                    ...
                                    <tr>
                                        ...
                                        <td colspan=4
                                            style="font-size:13px;background-color:#FFFFFF;padding:10px;font-weight:bold;">
                                            <a href="view?idx=<?=$row->idx?>&page=<?=$page?>&id=<?=$bbs_id?>"
                                               style="color:#17002f"><?=$row->bbs_subject?></a> <span
                                                    style="float:right;"><?=date($_CFG['default_date_format'], $row->bbs_regtt)?></span>

                                            <? if($is_admin){ ?>
                                            <div class="buttons"
                                                 style="text-align:right;background-color:white;white-space: nowrap;">
                                                <a onclick="location.href='<?=$req_path2;?>?idx=<?=$row->idx?>/write&mode=modify&a=write&id=<?=$bbs_id;?>&page=<?=$page?>'"
                                                   title="수정하기" class="normal-btn small1" style=""><em>수정하기</em></a>
                                                <a onclick="if(confirm('진짜냐?')){location.href='<?=$req_path2;?>/delete?idx=<?=$row->idx?>&a=del_process&bbs_writer=<?=$row->bbs_name;?>&page=<?=$page?>&id=<?=$bbs_id;?>';}"
                                    ...
                                    <tr style="display:none;">
                                        <td width=100
                                            style="font-size:12px;background-color:#EFEFEF;padding:10px;font-weight:bold;color:black;border-top:1px solid white;">
                                            Date
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4"
                                            style="font-size:12px;background-color:#FFFFFF;padding:10px;font-weight:bold;border-top:0px solid white;">
                                    ...
                                    <tr>
                                        <td colspan=4 valign='top'
                                            style='vertical-align:top;border-top:1px solid #d5d5d5;table-layout:fixed;padding:10px;border-bottom:0px solid #E0E1DB;height:200px;'>

                                            <div class="divcont" id=DivContents
                                                 style="vertical-align:top;font-size:14px;display:block;">
                                                <div><? // $imghtml?></div>
                                                <?=$row->bbs_content;?>
                                            </div>
                                        </td>
