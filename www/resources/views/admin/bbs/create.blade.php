  ...
  <div class="clearfix">
      <div>
          ...
          <div id='content_bbs' style="">
              ...
              <form action="create_ok" id="fwrite" name="fwrite" onsubmit="return fwrite_check(1)" enctype="multipart/form-data" method="POST">
                  {{ csrf_field() }}
                                          ...
                                          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                              <tr>
                                                  <td align="center">
                                                      ...
                                                      <a href="javascript:void(fwrite_check());" class="normal-btn small1" style=""><em>OK</em></a>

                                                      &nbsp;&nbsp;

                                                      <a href="javascript:location.href='list?page=<?=$page?>';" class="normal-btn small1" style=""><em>Cancel</em></a>
