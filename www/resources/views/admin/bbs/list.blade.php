...
*/
                          ...
                          foreach($list_info as $row){
                             $reg_time=$row->ts; // 등록시각
                              ...
                              ?>
                                  ...
                                  <tr>
                                      <td style="font-size:13px;background-color:#FFFFFF;padding:10px;font-weight:bold;"><a href="#<??>?a=view&idx=<?=$row->id?>&page=<?=$page?>" style="color:#17002f"><?=$row->bbs_name?></a></td>
                                      <td style="font-size:12px;background-color:#FFFFFF;padding:10px;font-weight:bold;border-top:1px solid white;"><?=$row->bbs_sid;?></td>
                                      ...
                                      <td>
                                          ...
                                          <div  class="buttons" style="text-align:right;background-color:white;white-space: nowrap;">
                                              <a onclick="location.href='edit?cafe_id=<?=$row->id?>/create&mode=modify&page=<?=$page?>'" title="수정하기" class="normal-btn small1" style=""><em>Edit</em></a>
                                              <a onclick="if(confirm('Are you sure?')){location.href='delete?bbs_sid=<?=$row->bbs_sid?>&a=del_process&page=<?=$page?>';}" class="normal-btn small1" style=""><em>Delete</em></a>
                                          </div>
                                          <? } ?>
                                      </td>
              ...
              <table border=0 cellspacing='0' cellpadding='7' width=100% height=25 style="padding-top:20px;">
                  ...
                  <tr>
                      <td width=100>
                          <a href='list?page=<?=$page?>' class="normal-btn small1" style="float:;"><em>list</em></a>
                      </td>
                      ...
                      <td align='right' width=100>
                          <? if($is_admin){ ?>
                            <a href="create" class="normal-btn small1" style="float:;"><em>add</em></a>
                          <? } ?>
                      </td>
                  </tr>
              </table>
              ...
              <div id='search' align='center'>
                  <form id='search_form' name='search_form' method='GET' action=<??> onsubmit="return form_chk();">
